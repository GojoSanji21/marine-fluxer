...
SHORTLINK_URL = os.environ.get("SHORTLINK_URL", "yorurl.com")
SHORTLINK_API = os.environ.get("SHORTLINK_API", "57433c090028e98ead5f62cf769408c659f9a1a9")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID","https://t.me/+avMZSoYhAwhhYjQ1")
...
try:
    ADMINS=[7263364323]
    for x in (os.environ.get("ADMINS", "1683225887 7827448605 7263364323").split()):
        ADMINS.append(int(x))
except ValueError:
